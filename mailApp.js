...
// check if it's all connected

const customElement = document.createElement('app-sidebar-button');
//creating the new custom HTML element 

const shadowRoot = customElement.attachShadow({mode: 'open'});
//attaching the shadow root to the custm element
...
<div class="button"
    ...
    <app-sidebar-button class="button button_inbox sidebar__button" text="Inbox"
...
//content whitin the shadow root
